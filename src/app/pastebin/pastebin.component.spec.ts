...
//Typescript declarations.
  ...
  beforeEach(()=> { 
    ...
    //The code below creates a Jasmine spy that is designed to track all calls to the getPastebin() method and return a promise that immediately resolves to mockPaste.
    mockPaste = [
